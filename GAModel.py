...
class GAModel:
    ...
    def __init__(self, name, estimator, cv=3, scoring="accuracy", max_features=10, n_population=153, cross_prob=0.5, muta_prob=0.2, n_gens=60, caching=True, muta_ind_prob=0.025, cross_ind_prob=0.8):
        self.name = name
