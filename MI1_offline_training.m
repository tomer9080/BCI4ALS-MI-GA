...
addpath('C:\Users\Latzres\Desktop\project\toolbox\liblsl-Matlab');     % lab streaming layer library
addpath('C:\Users\Latzres\Desktop\project\toolbox\liblsl-Matlab\bin'); % lab streaming layer bin

% Subject and recording parameters:
subID = input('Please enter subject ID/Name: ');    % prompt to enter subject ID or name
% rootFolder = 'C:\Users\Latzres\Desktop\project\Recordings\30-08-22\TK';
% animation = 0;
% tk_flag = 1;
rootFolder = 'C:\Users\Latzres\Desktop\project\Recordings\30-08-22\RL';
animation = 1;
tk_flag = 0;
